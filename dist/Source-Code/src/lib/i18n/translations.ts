...
export const translations = {
    en: {
        ...
        tools: {
            ...
            'arabic-literature': {
                ...
                analysisFull: 'Full Analysis',
                analysisSummary: 'Summary Only',
                analysisThemes: 'Themes Only',
                analysisQuestions: 'Questions Only'
            },
        ...
        common: {
            ...
            logoAlt: 'App Logo',
            generatedBy: 'Generated by AI Teacher Toolkit',
            generatedTitle: 'Resource Content',
            generateContent: 'Generate Content',
            generatingMagic: 'Generating Magic...',
            searchingCurriculum: '🔍 Searching global educational standards for lesson objectives...',
            searchGoogle: '🔍 Searching Google for "{{topic}}" educational standards...',
            searchBilingual: '🌐 Synchronizing international educational sources...',
            searchFound: '✅ Found relevant objectives in educational databases...',
            searchExtracting: '✨ Aligning content with universal curriculum standards...',
            refine: 'Refine',
            ...
            pdf: 'PDF',
            docx: 'DOCX',
            differentiationLabel: 'Learning Differentiation',
            none: 'None',
            support: 'Support',
            standard: 'Standard',
            challenge: 'Challenge',
    ...
    ar: {
        ...
        common: {
            ...
            generatedBy: 'تم إنشاؤه بواسطة صندوق أدوات المعلم',
            generatedTitle: 'الدرس المولد',
            generateContent: 'إنشاء المحتوى',
            generatingMagic: 'جاري إنشاء السحر...',
            searchingCurriculum: '🔍 جاري البحث عن أهداف الدرس في المعايير التعليمية العالمية...',
            searchGoogle: '🔍 جاري البحث في جوجل عن معايير موضوع "{{topic}}"...',
            searchBilingual: '🌐 جاري مزامنة المصادر التعليمية الدولية...',
            searchFound: '✅ تم العثور على أهداف مناسبة في قواعد البيانات التعليمية...',
            searchExtracting: '✨ جاري تنسيق محتوى الدرس مع المعايير العالمية...',
            refine: 'تحسين',
            ...
            pdf: 'PDF',
            docx: 'DOCX',
            differentiationLabel: 'التمايز التعليمي',
            none: 'بدون',
            support: 'احتياج ودعم',
            standard: 'طبيعي',
            challenge: 'تحدي وذكاء',
            select: 'اختر...',
            ...
            grades: {
                ...
                'Senior 1': 'الصف الأول الثانوي',
                'Senior 2': 'الصف الثاني الثانوي',
                'Senior 3': 'الصف الثالث الثانوي',
            },
            difficulty: {
                'Easy': 'سهل',
                'Medium': 'متوسط',
        ...
        chat: {
            ...
            subtitle: 'عصف ذهني وتخطيط مع الذكاء الاصطناعي',
            placeholder: 'اسألني أي شيء عن دروسك...',
            send: 'إرسال',
            welcome: 'مرحباً! كيف يمكنني مساعدتك في تدريسك اليوم؟',
            clear: 'مسح المحادثة',
