...
export function ChatView() {
    ...
    return (
        <div className="flex flex-col h-[calc(100dvh-130px)] md:h-[calc(100vh-40px)] max-w-6xl mx-auto bg-white rounded-2xl md:rounded-[3rem] border border-zinc-200 shadow-xl overflow-hidden shadow-zinc-200/50">
            {/* Header */}
