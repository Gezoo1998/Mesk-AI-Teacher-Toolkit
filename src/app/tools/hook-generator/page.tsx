    ...
    return (
        <div className="flex flex-col gap-6">
            <header className="border-b border-yellow-100 pb-4">
                <h2 className="text-xl font-semibold text-zinc-900">{t('tools.hook-generator.title')}</h2>
                <p className="text-sm text-zinc-600">{t('tools.hook-generator.description')}</p>
            </header>
